...
let person = {
  ...
  bio: function () {
    return `The interest of ${this.name.firstName}, of age ${this.age}, of gender ${this.gender} are ${this.interests}`;
  },
};

/* STEP 2a: Add other data items to the above object, like name, age, gender, address, and interests */
karan.name = "Karan Gill";
karan.age = 20;
karan.gender = "male";
karan.address = "";
karan.interests = ["swimming", "coding", "co-op gaming"];
...
karan.bio = function () {
  alert(
    `The interest of ${this.name}, of age ${this.age}, of gender ${this.gender} are ${this.interests}. He is also got a good sense of humor!`
  );
};
...
karan.bio = function () {
  return `The interest of ${this.name}, of age ${this.age}, of gender ${this.gender} are ${this.interests}. He is also got a good sense of humor!`;
};
...
karan.bio = function () {
  return `The interest of ${this.name.first}, of age ${this.age}, of gender ${this.gender} are ${this.interests}. He is also got a good sense of humor!`;
};
...
// [Answer] I understand, for example,
// console.log(karan["gender"]);    // --> this will also work & give us "male" as a result

/* STEP 8: You can also set members of an object - try changing the person's name, and age */
person.age = 18;

karan.name.first = "KARAN";
karan.age = 21;
...
karan.goodbye = function () {
  alert(`This is ${this.name.first} signing off!`);
};
